...
import { 
  Home, TrendingDown, ShieldAlert, MapPin, ArrowRight, 
  Star, TrendingUp, Sparkles, BarChart3, Newspaper, 
  Calculator, CircleDollarSign, Gauge, Activity, Layers, ArrowUpRight
} from 'lucide-react';
...
export default function RealEstateDashboard() {
  ...
  // Static, realistic placeholder data for the Australian Market. 
  ...
  const tools = [
    {
      id: 'rentvesting',
      title: 'The Rentvesting Validator',
      description: 'Compare the after-tax financial outcome of buying a PPOR vs. renting and investing your deposit.',
      icon: <Home className="w-8 h-8 text-[#9e1b32]" />,
    ...
    {
      id: 'yield-cashflow',
      title: 'Property Yield & Cashflow',
      description: 'Plug in purchase price, rent, and holding costs to instantly calculate your weekly out-of-pocket reality.',
      icon: <TrendingDown className="w-8 h-8 text-[#0a2540]" />,
      path: '/dashboard/yield-calculator',
      tag: 'Essential',
      tagIcon: <Calculator className="w-3.5 h-3.5 mr-1" />,
    ...
    {
      id: 'negative-gearing',
      title: 'Negative Gearing Engine',
      description: 'Model exactly how depreciation and expenses trigger ATO Stage 3 tax refunds to offset your holding costs.',
      icon: <CircleDollarSign className="w-8 h-8 text-[#0a2540]" />,
      path: '/dashboard/negative-gearing',
      tag: 'Post-Tax Reality',
      tagIcon: <ShieldAlert className="w-3.5 h-3.5 mr-1" />,
      color: 'from-amber-500/10 to-amber-500/5',
      metric: 'Stage 3 Compliant',
      trend: 'Tax Refund'
    },
    {
      id: 'purchasing-costs',
      title: 'State Purchasing Costs',
      description: 'Quickly estimate Stamp Duty, LMI, and conveyancing fees based on your specific Australian state brackets.',
      icon: <MapPin className="w-8 h-8 text-[#0a2540]" />,
  ...
  const insights = [
    ...
    },
    {
      ...
      value: marketMetrics.cashRate,
      label: 'Current Cash Rate',
      trend: marketMetrics.sentiment,
      color: 'text-amber-600'
    },
    {
      title: 'Strategy Tip',
      icon: <Newspaper className="w-5 h-5" />,
      value: 'Franking Credits',
      label: 'Dividend yield boost',
      trend: 'Learn more →',
      color: 'text-[#9e1b32]'
    }
  ];
  ...
  return (
    <div className="flex-1 min-h-screen bg-gradient-to-br from-[#f8fafc] via-[#f1f5f9] to-[#e9eef3] text-[#0a192f] font-sans overflow-x-hidden">
      ...
      <div className="fixed inset-0 opacity-20 pointer-events-none">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(158,27,50,0.08)_0%,transparent_50%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_70%,rgba(10,37,64,0.08)_0%,transparent_50%)]" />
      </div>
        ...
        <div className="mb-16 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-10">
          <div className="space-y-4 max-w-2xl">
            <div className="inline-flex items-center gap-2 bg-white/60 backdrop-blur-sm rounded-full px-4 py-1.5 border border-[#e2e8f0] shadow-sm">
              ...
              <span className="text-sm font-medium text-[#0a2540]/80">Australian Property Analytics</span>
            </div>
            ...
            <p className="text-[#475569] text-lg leading-relaxed max-w-xl">
              Institutional-grade calculators for property investors. Run your numbers instantly, stress-test worst-case scenarios, and invest with mathematical conviction.
            </p>
            <div className="flex flex-wrap gap-3 pt-2">
              ...
              <div className="flex items-center gap-2 text-sm text-[#475569] bg-white/50 backdrop-blur-sm rounded-full px-4 py-2 border border-[#e2e8f0]">
                <Calculator className="w-4 h-4 text-[#0a2540]" />
          ...
          <div className="w-full lg:w-auto bg-white/70 backdrop-blur-md rounded-2xl border border-white/50 shadow-xl p-6 min-w-[300px]">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div>
                <div className="text-3xl font-bold text-[#0a2540]">{marketMetrics.avgYield}</div>
                <div className="text-sm font-medium text-[#64748b] mt-1">Avg Gross Yield</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-[#0a2540]">{marketMetrics.cashRate}</div>
                <div className="text-sm font-medium text-[#64748b] mt-1">Cash Rate</div>
              </div>
            </div>
            <div className="mt-5 pt-4 border-t border-[#e2e8f0] text-xs font-medium text-[#64748b] flex justify-between">
              ...
              <span className="text-[#9e1b32]">RBA Consensus</span>
            </div>
          </div>
        </div>
